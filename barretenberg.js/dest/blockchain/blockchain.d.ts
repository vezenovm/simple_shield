...
export declare type PermitArgs = {
    deadline: bigint;
...
export interface Blockchain extends BlockSource, BlockchainStatusSource, EthereumSigner {
    ...
    createRollupProofTx(proof: Buffer, signatures: Buffer[], viewingKeys: Buffer[], providerSignature: Buffer, providerAddress: EthAddress, feeReceiver: EthAddress, feeLimit: bigint): Promise<Buffer>;
